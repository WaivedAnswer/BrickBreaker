...
void World::CreateWorld()
{
	...
	m_objList.push_back(new StandardWall(GRID_RATIO, GRID_RATIO/20.0, GRID_RATIO/2.0, 0.0));
	m_objList.push_back(new DeathWall(GRID_RATIO, GRID_RATIO/20.0, GRID_RATIO/2.0, GRID_RATIO+GRID_RATIO/20.0));
	m_objList.push_back(new StandardWall(GRID_RATIO/20.0, GRID_RATIO, 0.0, GRID_RATIO/2.0));
	m_objList.push_back(new StandardWall(GRID_RATIO/20.0, GRID_RATIO, GRID_RATIO, GRID_RATIO/2.0));
